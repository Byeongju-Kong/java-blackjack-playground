...
//        @Override
//        public List<Player> participate(final List<String> names) {
//            List<Player> participants = new ArrayList<>();
//            names.forEach(name -> participants.add(Player.of(name, provideInitialCards())));
//            participants.add(Player.of(provideInitialCards()));
//            return participants;
//        }
//
